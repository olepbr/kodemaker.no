...
På JavaZone 2022 hadde jeg en 20 minutters lyntale, en demo, av en god del verktøy som jeg bruker i hverdagen. Se gjerne den presentasjonen, lenke kommer snart. Denne bloggposten går igjennom alle verktøyene og teknikkene sånn at du slipper å notere underveis i presentasjonen.
...
Jeg håper du tok deg tid til å se presentasjonen for å se verktøyene "in action". Hovedpoenget med presentasjonen er ikke verktøyene i seg selv, men ha et bevisst forhold til hvordan en bruker datamaskinen. Jo mer effektivt den brukes, jo mer tid får en til å koding.